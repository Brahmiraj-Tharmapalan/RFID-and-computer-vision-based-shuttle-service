...
<body>
  <main>
    ...
    <h1 class="slideInDown animated">User View Only</h1>
    ...
    <section>
      <div class="slideInDown animated">
        <div class="imagelog">
          ...
          <div>
            <div class="login-page">
              <div class="form">
                ...
                <form class="login-form" action="ac_login_student.php" method="post" enctype="multipart/form-data">
                  <div class="input1">
          ...
          <button class="custom-btn btn-3" type="submit" name="login"><span>Login</span></button>
         <p class="message">Forgot your Password? <br><a href="#">Reset your password</a></p> -->
              </div>
            </div>
          </div>
    </section>
