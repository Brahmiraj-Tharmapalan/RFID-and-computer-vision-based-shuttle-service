...
<header>
	...
	<?php
	$activePage = ''; // Initialize the variable
	
	// Get the current page URL or any other logic to determine the active page
	$currentURL = $_SERVER['REQUEST_URI'];

	// Example: Check if the current URL contains a specific page name
	if (strpos($currentURL, 'index.php') !== false) {
		$activePage = 'Users';
	} elseif (strpos($currentURL, 'ManageUsers.php') !== false) {
		$activePage = 'ManageUsers';
	} elseif (strpos($currentURL, 'UsersLog.php') !== false) {
		$activePage = 'UsersLog';
	} elseif (strpos($currentURL, 'devices.php') !== false) {
		$activePage = 'Devices';
	}
	?>
	<div class="topnav" id="myTopnav">
		<a href="index.php" <?php if ($activePage == 'Users')
			echo 'class="active"'; ?>>Users</a>
		<a href="ManageUsers.php" <?php if ($activePage == 'ManageUsers')
			echo 'class="active"'; ?>>Manage Users</a>
		<a href="UsersLog.php" <?php if ($activePage == 'UsersLog')
			echo 'class="active"'; ?>>Users Log</a>
		<a href="devices.php" <?php if ($activePage == 'Devices')
			echo 'class="active"'; ?>>Devices</a>
		<?php
			...
			<form action="ac_update.php" method="POST" enctype="multipart/form-data">
				<div class="modal-body">
					...
					<input type="email" name="up_email" placeholder="Enter your E-mail..."
						value="<?php echo $_SESSION['Admin-email']; ?>" required readonly /><br>
					...
					<input type="password" name="up_pwd" placeholder="Enter your Password..."
						value="<?php echo $_SESSION['Admin-pwd']; ?>" required /><br>
					<label for="User-psw1"><b>New Password</b></label>
					<input type="password" name="up_pwd1" placeholder="Enter your New Password..."
						value="<?php $_SESSION['Admin-pwd']; ?>" /><br>
